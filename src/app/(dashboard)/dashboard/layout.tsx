...
<Image src="/chatman.svg" width={60} height={60} alt="logo"/>
        ...
        <nav className="flex flex-1 flex-col">
          ...
          />
                    ...
                    <span className="text-xs text-zinc-400 truncate w-36" aria-hidden="true">{session.user.email}</span>
                    </div>
                </div>
